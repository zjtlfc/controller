...
/*===============================================================宏定义区========================================================*/
/*=====================================与声音驱动相关宏定义=======================================================*/
#define	IIS_RECE_BUFF_SIZE		2400			/*IIS数据接收缓冲区大小*/
#define	SOUND_DRIVE_BUFF_SIZE		2400			/*声音驱动数据缓冲区大小*/
...
/*======================================与CAN发送相关宏定义===================================*/
#define     CAN_REPEAT_BUFFER_SIZE        8    /*CAN循环发送数据缓冲区数量*/
...
extern	unsigned	short		SoundOutputDriver1[];					/*驾驶员座椅声音输出1（数据：0—1666）*/
extern	unsigned	short		SoundOutputDriver2[];					/*驾驶员座椅声音输出2（数据：0—1666）*/	
...
extern   unsigned   int OutputLRData(unsigned short *,unsigned int,unsigned short *,unsigned int);	/*将运算输出缓冲区左右声道数据传输到驱动缓冲区*/
