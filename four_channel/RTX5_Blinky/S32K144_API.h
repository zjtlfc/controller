...
extern      void Fmt1Dma1Tran(unsigned char *,unsigned int);				/*FMT1，DMA1数据传输*/
extern      void Fmt1Dma2Tran(unsigned char *,unsigned int);				/*FMT1，DMA2数据传输*/
extern      void Fmt1Dma3Tran(unsigned char *,unsigned int);				/*FMT1，DMA3数据传输*/
